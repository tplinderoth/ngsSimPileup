...
const char* version = "0.4.0"; // version 12 April 2018
...
double alleleFreq (double freq, double lobound, double upbound, SFS* sfs, double cnvf = 0); // draw allele frequency
void info (const double& covmean, const double& covsd, const double& minfreq, const double& maxfreq, const double& avgqual, const double& maxqual, const double& beta,
		const double& encode, const std::string& name, const double* F, const bool& foldsfs, double deletionf, int help = 0, const char* v = version);
