...
public:
	...
	std::vector<rdat> genSeqData (const double afreq, const double inbreedcoef,
			const Array<double>* fitness, const unsigned int copyn = 1, const double pdup = 1.0); // generates sequencing data for a site
